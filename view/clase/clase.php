  ...
  <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>CLASE</h1>
            <button href="#addnew" class="btn btn-success" data-toggle="modal"> Clase</button>
	...
	<table class="table table-striped table-hover tabla">
        ...
        <a href="#delete_<?php echo $r->id; ?>"
				...
				<?php include('claseeditareliminar.php');?>	
				</div>		
			  </tr>
			<?php endforeach;?>			
		</tbody>
	  <?php include('clasenuevo.php');?>	
	</table>
